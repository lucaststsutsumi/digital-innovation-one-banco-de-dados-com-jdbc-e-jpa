...
public class JpqlExecution {
    public static void main(String[] args) {
        ...
        entityManager.persist(new Aluno(29, "Daniel", estadoParaAdicionar));
        entityManager.persist(new Aluno(20, "Joao", estadoParaAdicionar));
        entityManager.persist(new Aluno(30, "Pedro", estadoParaAdicionar));
